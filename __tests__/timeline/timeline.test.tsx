...
describe('EventTimeline', () => {
    beforeEach(() => {
        (useGetTimelinesByEventQuery as jest.Mock).mockReturnValue({
            data: [
                { id: '1', start_datetime: '2022-05-01T09:00:00Z', end_datetime: '2022-05-01T10:00:00Z', task_step: { name: 'Setup' } },
                { id: '2', start_datetime: '2022-05-01T11:00:00Z', end_datetime: '2022-05-01T12:00:00Z', task_step: { name: 'Teardown' } }
            ],
            isLoading: false,
            isError: false,
        });
    ...
    it('fetches and displays timeline events', async () => {
        render(
            <Provider store={store}>
                <EventTimeline id="123" budget={0} date={''} objective={''} attendees={0} theme={''} services={''} />
            </Provider>
        );
    });
