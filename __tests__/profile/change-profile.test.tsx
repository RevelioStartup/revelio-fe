...
describe('Test for ChangeProfile component', () => {
  beforeEach(() => {
    ...
    (useUpdateProfileMutation as jest.Mock).mockReturnValue([jest.fn().mockResolvedValue({ data: { bio: 'New bio' } }), {}]);
  ...
  it('includes profile picture in form submission', async () => {
    ...
    const fileInput = getByLabelText('Upload Profile Picture');
    const file = new File(['dummy content'], 'profile-picture.png', { type: 'image/png' });
