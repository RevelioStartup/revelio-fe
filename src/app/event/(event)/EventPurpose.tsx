...
export const EventPurpose: React.FC = () => {
    ...
    return (
        <form className = 'flex gap-12 w-full p-16 font-quicksand' data-testid = "purpose-form" onSubmit={handleSubmit(onSubmit)}>
            <div className = "flex flex-col gap-y-8 w-1/2">
                <h1 className = "font-bold lg:text-2xl md:text-xl text-base"> Let us know your event purpose </h1>
                <div className = "flex flex-col gap-y-4">
                    ...
                    <InputLabel id="services">What service(s) do you need in your event?</InputLabel>
                    <Select
                        labelId="services"
                        id="services"
                        multiple
            ...
            <div className = "flex flex-col gap-y-12 w-1/2">
                <Image src = "/assets/images/Illustration.svg" alt = "illustration" height={50} width = {50} className = "w-full" />
                <Button
                    type="submit"
